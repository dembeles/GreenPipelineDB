...
#define DEFAULT_TIME_WEIGHT 1
#define DEFAULT_POWER_WEIGHT 0
/* Power Model Regression Parameters (Bi) */
#define  B0  39.91
#define  B1  -0.000004582
#define  B2  0.000009017
#define  B3  0.0000000000002636
#define  B4  -0.0000000000008472
#define  B5  -0.000000000004072
...
extern Cost count_power_cost(double io_cost, double cpu_cost, double time,int wh);
