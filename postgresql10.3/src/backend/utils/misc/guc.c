...
static struct config_real ConfigureNamesReal[] =
{
	...
	{
		{"time_weight", PGC_USERSET, QUERY_TUNING_COST,
			gettext_noop("Sets the planner's weight of the time cost of a "
						 "plan."),
			NULL
		},
		&time_weight,
		DEFAULT_TIME_WEIGHT, 0, 1,
		NULL, NULL, NULL
	},
	
	{
		{"power_weight", PGC_USERSET, QUERY_TUNING_COST,
			gettext_noop("Sets the planner's weight of the power cost of a "
						 "plan ."),
			NULL
		},
		&power_weight,
		DEFAULT_POWER_WEIGHT, 0, 1,
		NULL, NULL, NULL
	},
